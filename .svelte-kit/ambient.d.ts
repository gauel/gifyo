...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_ios: string;
	...
	export const npm_package_devDependencies__fortawesome_free_regular_svg_icons: string;
	...
	export const npm_package_devDependencies__capacitor_haptics: string;
	export const npm_package_scripts_check: string;
	export const COLORTERM: string;
	export const npm_package_devDependencies_svelte_fa: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PNPM_HOME: string;
		USER: string;
		npm_package_scripts_ios: string;
		...
		XPC_FLAGS: string;
		npm_package_devDependencies__fortawesome_free_regular_svg_icons: string;
		...
		INFOPATH: string;
		npm_package_devDependencies__capacitor_haptics: string;
		npm_package_scripts_check: string;
		COLORTERM: string;
		npm_package_devDependencies_svelte_fa: string;

...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_videojs_record: string;
	...
	export const npm_package_dependencies_recordrtc: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_videojs_record: string;
		INIT_CWD: string;
		TERM: string;
		SHELL: string;
		...
		npm_package_dependencies_recordrtc: string;
